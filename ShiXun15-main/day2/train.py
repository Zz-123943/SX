...
# 准备数据集
train_data = torchvision.datasets.CIFAR10(root="E:\PycharmProjects\day1\day02\dataset_chen",
                                         train=True,
                                         transform=torchvision.transforms.ToTensor(),
                                         download=True)

test_data = torchvision.datasets.CIFAR10(root="E:\PycharmProjects\day1\day02\dataset_chen",
                                         train=False,
                                         transform=torchvision.transforms.ToTensor(),
                                         download=True )
